        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body border-bottom py-3">
                    <div class="d-flex">
                        ...
                        <div class="ms-auto text-secondary ">
                            <form method="GET"
                                action="{{route('jenis-perawatan.index')}}">
                ...
                <div class="table-responsive">
                    <table
                        ...
                        <tbody>
                            ...
                            @endphp
                            @foreach($jenisPerawatans as $jenisPerawatan)
                            <tr>
                                <td class="text-secondary">{{++$no}}</td>
                                <td class="text-secondary py-3">{{$jenisPerawatan->nama}}</td>
                                <td>
                                    {{$jenisPerawatan->biayaInRupiah()}}
                                </td>
                                <td class="text-end">
                                    <span class="dropdown">
                                        <button
                                        ...
                                        <div
                                            ...
                                            <a class="dropdown-item"
                                                href="{{route('jenis-perawatan.edit',$jenisPerawatan->id)}}">
                                                Edit
                                            </a>
                                            <a class="dropdown-item"
                                                form="delete" href="#"
                                                onclick="showingDeleteConfirmation(this,{{$jenisPerawatan->id}})">
                                                Delete
                                            </a>
                                            <form class="d-none"
                                                id="delete{{$jenisPerawatan->id}}"
                                                method="POST"
                                                action="{{route('jenis-perawatan.destroy',$jenisPerawatan->id)}}">
                                                @method('delete')
                                                @csrf
                                            </form>
                                        </div>
                ...
                <div class="card-footer d-flex align-items-center">
                    {!! $jenisPerawatans->appends(request()->query())->links()
                    !!}
                </div>
            </div>
        </div>
